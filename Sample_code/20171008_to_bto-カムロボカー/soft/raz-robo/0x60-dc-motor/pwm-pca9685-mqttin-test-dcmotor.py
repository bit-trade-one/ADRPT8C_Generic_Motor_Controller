...
#{"ch3": 0, "ch4": 0, "ch2": 4093, "ch1": 4094, "ch5": 0, "ch0": 0, "ch7": 1278, "ch6": 0}
#ch0= 0
    pwm.set_pwm(0, 0,r2["ch0"])
    pwm.set_pwm(1, 0,r2["ch1"])
    pwm.set_pwm(2, 0,r2["ch2"])
    pwm.set_pwm(3, 0,r2["ch3"])
    pwm.set_pwm(4, 0,r2["ch4"])
    pwm.set_pwm(5, 0,r2["ch5"])
    pwm.set_pwm(6, 0,r2["ch6"])
    pwm.set_pwm(7, 0,r2["ch7"])
    ...
    #pwm.set_pwm(6, 4096-r2["ch4"],r2["ch4"])
    #pwm.set_pwm(7, 4096-r2["ch5"],r2["ch5"])
